...
CREATE UNIQUE INDEX "clients_tenant_oauth_client_id_unique" ON "clients" USING btree ("tenant_id","oauth_client_id") WHERE "oauth_client_id" is not null;--> statement-breakpoint
...
CREATE UNIQUE INDEX "oauth_access_tokens_refresh_token_hash_unique" ON "oauth_access_tokens" USING btree ("refresh_token_hash") WHERE "refresh_token_hash" is not null;--> statement-breakpoint
