...
const sheetContentVariants = cva(
  "fixed z-50 flex flex-col gap-4 bg-popover text-popover-foreground shadow-none ring-1 ring-foreground/10 transition ease-in-out data-open:animate-in data-closed:animate-out data-closed:duration-200 data-open:duration-200",
  {
    variants: {
      side: {
        right:
        ...
        top:
          "inset-x-0 top-0 max-h-[90vh] border-b border-border data-closed:slide-out-to-top data-open:slide-in-from-top",
        bottom:
          "inset-x-0 bottom-0 max-h-[90vh] border-t border-border data-closed:slide-out-to-bottom data-open:slide-in-from-bottom",
      },
    },
    defaultVariants: {
      side: "right",
